...
Feature: Divide operation tests
  ...
  Scenario Outline: Should calculate the correct number where <Message> (Build: <Build>)
    ...
    Examples:
      ...
      | one of the numbers is fraction                      | Prototype | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | Prototype | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | Prototype | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 1         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 1         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 1         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 2         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 2         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 2         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 3         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 3         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 3         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 4         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 4         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 4         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 5         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 5         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 5         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 6         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 6         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 6         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 7         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 7         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 7         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 8         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 8         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 8         | 10.35       | 1.5        | true         | 6                  |
      ...
      | one of the numbers is fraction                      | 9         | 34.98765    | 2          | false        | 17.493825          |
      | both of the numbers are positive with integers only | 9         | 1           | 2          | true         | 0                  |
      | both of the numbers are fraction with integers only | 9         | 10.35       | 1.5        | true         | 6                  |
  ...
  Scenario Outline: Should display error message (<ErrorMessage>) when <Message> (Build: <Build>)
    ...
    Examples:
      ...
      | second number is 0                               | Prototype | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 1         | 0       | test    | Divide by zero error!    |
      ...
      | second number is 0                               | 2         | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 3         | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 4         | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 5         | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 6         | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 7         | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 8         | 2       | 0       | Divide by zero error!    |
      ...
      | second number is 0                               | 9         | 2       | 0       | Divide by zero error!    |
