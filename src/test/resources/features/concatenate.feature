...
Feature: Concatenate operation tests
  ...
  Scenario Outline: Should calculate the correct string where <Message> (Build: <Build>)
    ...
    Examples:
      ...
      | both of the numbers are string                   | Prototype | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | Prototype |             |            |                      |
      ...
      | both of the numbers are string                   | 1         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 1         |             |            |                      |
      ...
      | both of the numbers are string                   | 2         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 2         |             |            |                      |
      ...
      | both of the numbers are string                   | 3         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 3         |             |            |                      |
      ...
      | both of the numbers are string                   | 4         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 4         |             |            |                      |
      ...
      | both of the numbers are string                   | 5         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 5         |             |            |                      |
      ...
      | both of the numbers are string                   | 6         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 6         |             |            |                      |
      ...
      | both of the numbers are string                   | 7         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 7         |             |            |                      |
      ...
      | both of the numbers are string                   | 8         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 8         |             |            |                      |
      ...
      | both of the numbers are string                   | 9         | test        | number     | testnumber           |
      ...
      | both of the numbers are empty                    | 9         |             |            |                      |
